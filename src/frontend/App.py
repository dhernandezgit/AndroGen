...
class App:
    ...
    def _update_colors(self, head_color, head_highlight_color, neck_color, tail_color, droplet_color, debris_color, shadow_start_color, shadow_end_color, scale, shadow_offset, shadow_scale, n_points):
    ...
    def init_components(self):
        ...
        with gr.Blocks(css=custom_css, fill_width=True, fill_height=True, theme=gr.themes.Soft()) as self.app:
            with gr.Row():
                with gr.Sidebar(width = "35%") as col_left:
                    with gr.Tabs():
